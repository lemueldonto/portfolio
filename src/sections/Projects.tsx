...
const lead: L = {
  en: 'Two ventures I architect and build with a team of three — end to end, from the problem to production.',
  fr: 'Deux projets que j’architecture et construis avec une équipe de trois — de bout en bout, du problème à la production.',
}
